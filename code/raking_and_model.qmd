...
This document pertains the corrections on the clean dataset created in `Data_cleaning_and_covariates_Jan_05.qmd`. There are differences in the proportions of the dataset with regard to income, age groups, race/ethnicity, and geographical location when compared to the Census data. The dataset will be corrected using _raking_ with the package `survey`.

# Raking

This section follows the steps provided by [https://sdaza.com/blog/2012/raking/](https://sdaza.com/blog/2012/raking/) https://www.r-bloggers.com/2018/12/survey-raking-an-illustration/
