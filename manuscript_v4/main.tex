...
vaccination uptake between the Health Regions of Ontario during the last
quarter of 2021.To better contextualize potential differences, we also
included socio-economic factors in our analysis in order to identify in
which demographic groups these differences were significant.
...
information from participants (\textbf{?@tbl-covariates}), recorded
...
\textbf{?@tbl-covariates}, the month when the survey was answered, the
...
(\textbf{?@tbl-covariates}) and the Census data for Ontario, we used an
