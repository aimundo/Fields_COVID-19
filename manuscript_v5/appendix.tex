...
\hypertarget{tbl-central-hr-lhin}{}
\begin{table}
\caption{\label{tbl-central-hr-lhin}Proportion of answers by LHIN (Central Health Region) }\tabularnewline

\centering
\begin{tabular}{lc}
\toprule
\textbf{Characteristic} & \textbf{N = 1,455}\\
\midrule
\textbf{LHIN} & \\
\hspace{1em}Mississauga Halton & 495 (34\%)\\
\hspace{1em}Central & 428 (29\%)\\
\hspace{1em}Central West & 362 (25\%)\\
\hspace{1em}North Simcoe Muskoka & 170 (12\%)\\
\bottomrule
\multicolumn{2}{l}{\rule{0pt}{1em}\textsuperscript{1} n (\%)}\\
\end{tabular}
\end{table}
