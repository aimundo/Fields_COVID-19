...
Tables A-7 and A-8 present summaries of information from the Fields survey (from the dataset analyzed in the main paper), showing responses by White/Caucasian individuals by Health Region and proportion of answers by LHIN in the West Health Region.
...
clean_data %>% subset (Race=="White/Caucasian")%>%
  ...
  # clean_data %>%
  # select(Race,Health_Region,first_dose) %>%
  # tbl_strata(
  #   strata = Health_Region,
  #   .tbl_fun =
  #     ~ .x %>%
  #       tbl_summary(by = first_dose, missing = "no",percent="row") %>%
  #       add_n(),
  #   .header = "**{strata}**, N = {n}"
  # )%>%
  # bold_labels()%>%
...
```{r,West-HR-Indigenous}
#| label: tbl-west-region-indigenous
#| tbl-cap: "Proportion of answers by LHIN in the West Health Region for Indigenous Individuals"
#| message: false
#| echo: false
...
```{r,West-HR-Mixed}
#| label: tbl-west-region-mixed
#| tbl-cap: "Proportion of answers by LHIN in the West Health Region for Mixed Individuals"
#| message: false
#| echo: false
...
```{r,East-HR-Arab}
#| label: tbl-East-region-Arab
#| tbl-cap: "Proportion of answers by LHIN in the East Health Region for Arab/Middle Eastern Individuals"
#| message: false
#| echo: false

a1_rake %>%
  subset(Health_Region=="East" & Race=="Arab/Middle Eastern")%>%
