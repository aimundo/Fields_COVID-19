...
``complete'' and that had complete answers for all covariates considered
in our analysis. Later, we matched the city of each observation with its
...
analysis was 6,236 which included the East, Central, Toronto, and West
Health Regions covering the period between October 1st,2021 and January
17, 2022. The original dataset, clean dataset, and details on the data
