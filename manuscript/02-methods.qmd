...
Socio-economic information selected from the survey answers included age group, income bracket, and race/ethnicity. The levels of each socio-economic factor used for analysis appear in @tbl-covariates.
