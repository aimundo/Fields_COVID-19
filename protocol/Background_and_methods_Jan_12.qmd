...
a<-modelplot(model1,coef_omit = ':')+aes(color = ifelse(p.value < 0.05, "Significant", "Not significant")) +
  scale_color_manual(values = c("black", "red"))+ggtitle("First Model")

b<-modelplot(model2,coef_omit = ':')+aes(color = ifelse(p.value < 0.05, "Significant", "Not significant")) +
  scale_color_manual(values = c("black", "red"))+ggtitle("Second Model")
...
a+b+c+plot_layout(guides = 'collect')+plot_annotation(title="Fixed effects of all models")& theme(legend.position = 'bottom')
  

d<-modelplot(model1,coef_omit = "^(?!.*:)")+aes(color = ifelse(p.value < 0.05, "Significant", "Not significant")) +
  scale_color_manual(values = c("black", "red"))+ggtitle("1st Model")
...
d+e+f+plot_layout(guides = 'collect')+plot_annotation(title="Interaction effects of all models") & theme(legend.position = 'bottom')
