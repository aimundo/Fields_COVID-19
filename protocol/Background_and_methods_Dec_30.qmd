...
For each survey participant certain data was automatically captured. This included the nearest municipality, which resulted in a total of 578 different municipalities within the dataset. Because our interest lies in exploring vaccination status within a governamental administrative unit that encompasses multiple cities, we grouped the municipalities from the dataset according to the regional government aggregations provided by the Association of Municipalities of Ontario, which groups municipalities within regions, counties, districts, and single-tiers [@ontario-municipalities]. The geographical regions were obtained from the websie of the province of Ontario [https://www.ontario.ca/page/list-ontario-municipalities#section-3](https://www.ontario.ca/page/list-ontario-municipalities#section-3)
